...
export default {
  ...
  head: {
    ...
    meta: [
      ...
      { hid: 'og:image', property: 'og:image', content: process.env.VUE_APP_BASE_URL + '/logo-name.svg' },
      { hid: 'og:image:type', property: 'og:image:type', content: 'image/svg+xml' },
      { hid: 'og:image:width', property: 'og:image:width', content: '1200' },
      { hid: 'og:image:height', property: 'og:image:height', content: '627' },
      { hid: 'og:url', property: 'og:url', content: process.env.VUE_APP_BASE_URL }
    ],
